...
keywords:
  - ReflectLoop
  - Reflectloop-Desktop-Agent
  - repository rename
  - GitHub rename
  - zhiji compatibility
---

# ReflectLoop 仓库命名迁移与兼容性记录

本文记录 2026-08-22 晚间的 GitHub 仓库改名、相关文档与 metadata 调整，以及“本地仍有知己/zhiji 是否会损坏”的判断。它是后续遇到克隆、推送、链接、构建、数据目录或旧名称问题时的原因查询入口。
