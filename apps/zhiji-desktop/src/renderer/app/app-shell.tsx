...
import { AgentIcon, HistoryIcon, ProjectsIcon, ReviewsIcon, SettingsIcon, TodayIcon, TopicsIcon } from '../components/icons';
import { APP_NAVIGATION, type AppView, type NavigationTarget } from './navigation';
const icons = { start: TodayIcon, agent: AgentIcon, journal: HistoryIcon, reviews: ReviewsIcon, topics: TopicsIcon, projects: ProjectsIcon, settings: SettingsIcon };
