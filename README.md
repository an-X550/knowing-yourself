...
[![Version](https://img.shields.io/badge/版本-v1.6.8-green)](VERSION)
...
| 主题思考 | 想深入讨论任意长期问题，并在以后继续沿用或修正认识 | 困扰、理解、审查、保留、尝试与演化六问闭环 |
...
直接用自然语言开始探讨。形成相对明确的认识后，AI 会先展示“我在困扰什么、我目前怎么理解、我凭什么这样想且哪里可能错、什么值得继续保留、接下来怎么试、我的看法怎么变了”。它必须区分事实、推断与建议，并为严肃挑战给出反例、证据缺口或替代解释。只有你确认后，才会在 `关于我/思考/` 动态创建或更新对应主题文件。这里没有固定主题清单。

六问是帮助思考闭环的问题清单，不是六段等长作文。系统会按证据、问题复杂度和行动需要决定哪一节展开：有明确行动、高风险判断或反例时写细；没有新证据时短写并说明原因，不为了填满标题增加泛泛内容。
