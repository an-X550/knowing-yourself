...
- 产品哲学与人类提醒：[`docs/first-principles.md`](docs/first-principles.md)
- AI 运行原则：[`.claude/shared/ai-operating-principles.md`](.claude/shared/ai-operating-principles.md)
...
- 行为模式沉淀：`关于我/verified-patterns.md`
