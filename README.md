...
[![Version](https://img.shields.io/badge/版本-v1.24.8-green)](VERSION)
...
本地飞书日反馈入口已于 2026-08-20 **弃案**：代码、配置示例和验收记录仍保留，但监听启动已注释，当前不应部署。日常飞书交互改由 WorkBuddy 的工作区代理承担；恢复旧入口前须重新验证额度、事件连接与路由体验。详见[弃案说明](docs/local-feishu-daily-feedback-entry.md)。
