...
[![Version](https://img.shields.io/badge/版本-v1.6.12-green)](VERSION)
...
主题板块是帮助思考闭环的结构清单，不是等长作文。系统会按证据、问题复杂度和行动需要决定哪一节展开：执行信息前置，分析信息归位；行动卡优先用表格呈现，下一步优先用编号步骤呈现；没有新证据时短写并说明原因，不为了填满标题增加泛泛内容。
