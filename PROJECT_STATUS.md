...
| 可选结果分发 | 飞书白名单已配置，待日常新产物观察 | 新生成的正式复盘、人生设计、已确认主题思考及明确收录的收藏/附件可按固定“知己”目录沉淀到飞书；滴答仍只消费报告内已有的合格行动。本地文件始终权威，不扫描电脑，不上传日志、画像、中间分析、配置或状态。飞书根目录与 10 个固定目录已真实核验；历史 60 项须经人工确认后同步。 |
